        ...
        >
            ...
            <div className="flex flex-col lg:flex-row gap-8 px-4 lg:px-12">
                <div className="w-full lg:w-2/3 p-4">
                    ...
                    <div className="p-3"><h1 className="text-2xl text-gray-600">FINANCE</h1>
                        <h1 className="font-bold py-4 text-2xl md:text-3xl lg:text-5xl leading-tight">Why July 23, 2024, is a game-changer for capital gains in your 2025 ITR filing?</h1>
                        <p className="text-gray-700 leading-7">Lorem ipsum dolor sit amet consectetur. Amet felis in lorem praesent viverra. Sit rhoncus nibh a praesent mi nunc enim. Laoreet eget libero donec dictum quam arcu. Morbi est neque aliquam sed nulla volutpat vitae. Aliquet molestie eu placerat metus posuere eget. </p>
            ...
            <div className="lg:sticky lg:top-24 space-y-8">
                <div className="bg-gray-50 rounded-xl p-6 shadow-sm">
                    <h1 className="font-bold text-2xl py-3">Content</h1>
                    <ul className="space-y-1.5">
                        <li className="flex items-center gap-2 text-gray-600 hover:text-blue-600 cursor-pointer transition-colors"><span className="mr-1">|</span>Heading</li>
                ...
                <div className="w-full lg:w-2/3 px-4 lg:px-0">
                    ...
                    <h1 className="font-bold">Latest News & Topics</h1>
                    <div className="flex flex-row items-center justify-between gap-4 py-3">The story trend behind MSNBC's silly new name
                        <Image
                    ...
                    <div className="flex flex-row items-center justify-between gap-4 py-3">The strange reason why the Trump administration suddenly cares about these birds
                        <Image
                    ...
                    <hr className="mt-4 border-gray-300"/>
                    <div className="flex flex-row items-center justify-between gap-4 py-3">A dangerous new idea about what Democrats are doing wrong
                        <Image
